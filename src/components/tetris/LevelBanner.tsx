...
export function LevelBanner({ niveau, score, blocsPlaces, lines, nextPieceShape, nextPieceColor }: Props) {
  return (
    <div className="flex flex-row lg:flex-col gap-3 lg:gap-4 flex-wrap justify-center">
      <div className="rounded-xl border border-white/10 bg-white/5 p-3 lg:p-4 min-w-[80px] lg:min-w-[176px]">
        <div className="mb-1 text-[10px] lg:text-xs uppercase tracking-widest text-slate-400">Niveau</div>
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 p-3 lg:p-4 min-w-[80px] lg:min-w-[176px]">
        <div className="mb-1 text-[10px] lg:text-xs uppercase tracking-widest text-slate-400">Score</div>
        <div className="text-base lg:text-xl font-bold text-white">{score.toLocaleString()}</div>
      </div>

      <div className="rounded-xl border border-white/10 bg-white/5 p-3 lg:p-4 min-w-[80px] lg:min-w-[176px]">
        <div className="mb-1 text-[10px] lg:text-xs uppercase tracking-widest text-slate-400">Blocs</div>
        <div className="text-base lg:text-xl font-bold text-white">{blocsPlaces}</div>
      </div>

      <div className="rounded-xl border border-white/10 bg-white/5 p-3 lg:p-4 min-w-[80px] lg:min-w-[176px]">
        <div className="mb-1 text-[10px] lg:text-xs uppercase tracking-widest text-slate-400">Lignes</div>
        <div className="text-base lg:text-xl font-bold text-white">{lines}</div>
      </div>

      {nextPieceShape && (
        <div className="rounded-xl border border-white/10 bg-white/5 p-3 lg:p-4 min-w-[80px] lg:min-w-[176px]">
          <div className="mb-2 text-[10px] lg:text-xs uppercase tracking-widest text-slate-400">Suivante</div>
